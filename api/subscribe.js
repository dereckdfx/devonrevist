...
const SITE_KEY = 'devon-usa';           // value the page sends as "list"
const LIST_NAME = 'Devon USA';         // Brevo list name (looked up if no id is configured)
const LIST_ID = 6;               // Brevo list id (null => BREVO_LIST_ID env or lookup by name)
